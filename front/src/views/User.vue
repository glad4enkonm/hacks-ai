      ...
      <section class="section">
        <div className="flx-space-btw">
          <div class="section__title">
            <span class="section__title-accent">{{ ru.user.caption }}</span>
          </div>
        </div>
        <div className="flx">
        ...
        <div class="table">
          <div class="table__row table__header">
            ...
            <div class="table__row-item table__row-item-30 flx-jcc">Имя</div>
            <div class="table__row-item table__row-item-30 flx-jcc">Login</div>
            <div class="table__row-item table__row-item-30 flx-jcc">Описание</div>
